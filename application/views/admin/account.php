...
?>
  ...
  <link rel="stylesheet" href="resource/css/jquery.autocomplet.css" type="text/css" />
  <link rel="stylesheet" href="resource/css/dinastyle.php" type="text/css" />
    ...
    <script type="text/javascript" src="resource/js/accountadminforms.js"></script>
...
<div id="content">
	...
	?>
		...
		<a href='admin/account' title=''>Ver todo</a>&nbsp;|&nbsp;
		<a href='admin/account' id='form_account_create' title=''>Crear nuevo</a>&nbsp;|&nbsp;
			<?php echo form_open("admin/account/search"); ?>
                ...
                <br />
                <?php echo form_input(array("name"=>"search_term","value"=>$search_term,"size"=>20,"id"=>"account_search_term")); ?>

               	<a href='buscar' title='Buscar' id='account_search'>Buscar</a><br />
		...
		<div id='div_account_table'>
		<h3><?=$this->lang->line('account-mng');?></h3>
			<?php echo $this->account_model->table(); ?>
		</div>	
